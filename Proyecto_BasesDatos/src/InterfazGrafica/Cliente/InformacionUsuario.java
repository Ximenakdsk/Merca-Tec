...
public class InformacionUsuario extends javax.swing.JDialog {
    ...
    public InformacionUsuario(java.awt.Frame parent, boolean modal, Clientes cliente){
        super(parent, modal);
        initComponents();
        lblNombreC.setText(cliente.getNombre() + " " + cliente.getApellidoP() + " " + cliente.getApellidoM());
        lblTelefono.setText(cliente.getTelefono());
        lblEmail.setText(cliente.getEmail());
        lblDireccion.setText(cliente.getCalle() + " No." + cliente.getNumero() + ", " + cliente.getCodigoPostal() + ", " + cliente.getCoDomicilio());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Información de Mi cuenta");
